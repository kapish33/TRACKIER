...
const Dashboard = () => {
  ...
  return (
    <>
      <FIlters />
      <div className='relative h-[660px] overflow-auto bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 p-5'>
        {/* Paginated start/ */}
      ...
      {/* Buttons  */}
      <div className='xs:mt-0 bg mt-2 inline-flex p-5'>
        <button
          onClick={Prev}
          disabled={start === 0}
