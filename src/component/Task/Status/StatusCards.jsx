...
const StatusCards = ({ taskID, uuid, title }) => {
  ...
  return (
    <div className='flex flex-col'>
      ...
      <div className='m-1 block w-52 max-w-sm rounded-lg border border-gray-200 bg-gray-100 p-6 text-center font-bold capitalize text-green-500 shadow  dark:border-gray-700 dark:bg-gray-800'>
